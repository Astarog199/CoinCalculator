...
data class CoinCalculatorDto(
    @Json(name = "id") val id: String,
    @Json(name = "symbol") val symbol: String,
    @Json(name = "name") val name: String,
    @Json(name = "image") val image: String,
    @Json(name = "current_price") val currentPrice: Float,
    @Json(name = "market_cap") val marketCap: Float,
    @Json(name = "market_cap_rank") val marketCapRank: Long,
    @Json(name = "fully_diluted_valuation") val fullyDilutedValuation: Float,
    @Json(name = "total_volume") val totalVolume: Float,
